...
export interface SectionItem extends Details {
  src: string;
...
export const whoHelpsUs: Section[] = [
  {
    sectionTitle: {
    ...
    items: [
      {
        src: '/img/avatars/Waone_Manzhos.webp',
        imgClassName:
      ...
      {
        src: '/img/avatars/danyla_shulipa.webp',
        imgClassName:
          'rounded-full w-[90px] h-[90px] tablet:w-[120px] tablet:h-[120px]',
        title: 'Danya Shulipa',
        description: {
      ...
      {
        src: '/img/avatars/Irene_Neyman.webp',
        imgClassName:
          'rounded-full w-[90px] h-[90px] tablet:w-[120px] tablet:h-[120px]',
        title: 'Irene Neyman',
        description: {
    ...
    items: [
      {
        ...
        links: [
          {
            label: 'kindustry.com',
            url: 'https://www.kindustryandco.com/',
          },
        ],
      },
      {
