...
import { atcb_action, atcb_init, ISO8601Date, ISO8601Time  } from 'add-to-calendar-button';
...
type AddToCallendarEvent = {
  ...
  endTime: ISO8601Time,
  timeZone: string,
  options: ("Apple" | "iCal" | "Microsoft365" | "Outlook.com" | "MicrosoftTeams" | "Yahoo" | "Google")[],
  trigger: "click",
  iCalFileName: string
};
...
const Countdown = ({countDownDate}: CountdownProp) => {  
  ...
  const event: AddToCallendarEvent = {
    ...
    description: "META HISTORY NFTs second drop on [url]https://metahistory.gallery/[/url]",
