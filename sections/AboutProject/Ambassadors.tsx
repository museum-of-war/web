  ...
  return (
    <div className="font-rlight desktop:py-120px tablet:py-[96px] mobile:py-60px">
      ...
      <div className="flex desktop:flex-row tablet:flex-row mobile:flex-col justify-between flex-wrap">
        {data.map(datum => (
          <div className="flex flex-col desktop:mt-40px tablet:mt-40px mobile:mt-32px desktop:basis-1/4 tablet:basis-1/2 mobile:basis-1" key={datum.name}>
            ...
            <div className="font-rblack flex flex-row cursor-pointer text-14px desktop:leading-48px tablet:leading-48px mobile:leading-40px" onClick={() => {
